...
| 📖 | [Translate a Book with AI](https://translateabook.com/) | Quality book AI translations using the current top LLMs, that preserves layout - join our thousands of authors, publishers and readers | **30% off** all translations until Nov 31st with code **BF30**. |
